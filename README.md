...
## Solution Pre-requisite
  ...
  4. update tow github secrets with name AWS_ACCESS_KEY_ID , AWS_SECRET_ACCESS_KEY.
...
## About CloudFormation Templates:
  ...
  1. [First Stack](MyNetwork.yaml) is to provision the VPC, Subnets Route tables, Nat Gateway and all resources needed by netowrking for this solution.
